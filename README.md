...
When running the code, please `Enable Dynamics` in Wolfram Mathematica for the simulation.
<img width="713" height="737" alt="dynamic_sim" src="https://github.com/user-attachments/assets/b7d2559a-1596-47bb-85a9-72ffe83f7d3d" />
...
This framework even extends to more imaginative scenarios, such as `Human - Zombie - Third Species` systems. What if there was a third “resistants” or “mutants” population that can cure zombies but can be lose immunity by human? Or “new carrier” status that can infect zombies, but cured by human? This opens the door to richer, more biologically and socially inspired dynamics.
